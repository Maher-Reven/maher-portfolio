...
export function Spotlight({
  ...
  useEffect(() => {
    ...
    // Named handlers, so removeEventListener actually removes them. The
    // original passed fresh arrow functions to both add and remove, which
    // leaves the listeners attached for the life of the element.
